...
open class PKHUD: NSObject {
    ...
    open func show(onView view: UIView? = nil, dimsBackground: Bool = true, canClose: Bool = true) {
        ...
        if let squareView = container.frameView.content as? PKHUDSquareBaseView, canClose {
            squareView.closeButton.isHidden = false
            squareView.closeButton.addTarget(self, action: #selector(onHide), for: .touchUpInside)
        }
