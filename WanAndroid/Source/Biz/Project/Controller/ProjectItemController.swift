...
class ProjectItemController: UIViewController {
    private let viewModel: ProjectItemViewModel

    init(chapterId: Int) {
        self.viewModel = ProjectItemViewModel(chapterId: chapterId)
...
extension ProjectItemController: AutoDisposed {
...
extension ProjectItemController: UITableViewDataSource, UITableViewDelegate {
...
extension ProjectItemController: JXSegmentedListContainerViewListDelegate {
